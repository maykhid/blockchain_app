...
class TezosTransactionDetailsScreen extends StatelessWidget {
  const TezosTransactionDetailsScreen({
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TransactionDetailsTile(
                title: 'Level',
                info: transaction.level.toString(),
              ),
              const AppDivider(),
              ...
              TransactionDetailsTile(
                title: 'Reward',
                info: transaction.reward.toString(),
              ),
              const AppDivider(),
              ...
              TransactionDetailsTile(
                title: 'Bonus',
                info: transaction.bonus.toString(),
              ),
              const AppDivider(),
              ...
              TransactionDetailsTile(
                title: 'Fees',
                info: transaction.fees.toString(),
              ),
